...
function DSA() {
  ...
  const filteredResources = resources.filter(
    (resource) => filter === "All" ? true : (resource.category === filter)
  );
  ...
  const handleSearchInput = (e) => {
   ...
   const filteredData = filteredResources.filter((resource) =>               resource.title.toLowerCase().includes(querry.toLowerCase()));
